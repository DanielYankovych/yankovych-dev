export const REACT_LOGO = require("@/assets/react-logo.svg").default.src;
export const NEXT_LOGO = require("@/assets/next-logo.svg").default.src;
export const TAILWIND_LOGO = require("@/assets/tailwind-logo.svg").default.src;

export const JS_LOGO = require("@/assets/js-logo.svg").default.src;
